#!/usr/bin/env python3
"""Stub backend shim for common_lisp^(...)_common_lisp blocks.

This is a placeholder. It returns the code text as an OStr so that .O
files containing common_lisp^ blocks at least parse and evaluate without crashing
the runtime. Replace this with a real common_lisp-execution shim when ready.
"""
import sys
import json
import traceback
